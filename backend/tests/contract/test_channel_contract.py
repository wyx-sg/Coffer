...
structurally matches openspec/specs/channels/contracts/api.openapi.yaml.
...
_CHANNEL_OPENAPI_PATH = (
    Path(__file__).resolve().parents[3] / "openspec/specs/channels/contracts/api.openapi.yaml"
)
