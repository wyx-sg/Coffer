...
@pytest.mark.acceptance(spec="chat", scenario="send a message and receive a streamed reply")
...
@pytest.mark.acceptance(spec="chat", scenario="observe a turn started from another surface")
...
@pytest.mark.acceptance(spec="chat", scenario="reply survives a restart")
