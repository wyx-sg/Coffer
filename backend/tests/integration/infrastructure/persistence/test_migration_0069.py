...
the event over because it has to work with no daemon running (spec mcp-gateway
FR-028). 0055 set the rule for what happens to the rows such an event already
