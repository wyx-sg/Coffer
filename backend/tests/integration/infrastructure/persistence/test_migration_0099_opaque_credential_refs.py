"""0099 — a channel's and an mcp_server's credential refs stop naming the resource.
...
def _insert_resource(conn: sqlite3.Connection, kind: str, name: str, config: dict) -> None:
    """A resource as it exists at 0098 — with the uid 0095 would have derived
...
def _seed(db: pathlib.Path, at: str = "0098") -> AlembicConfig:
