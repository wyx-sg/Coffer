...
from coffer.application.knowledge.consolidate import StoreConsolidator, merge_store_dir
...
async def test_consolidator_collapses_stale_worktree_store(mem):
    ...
    canonical_dir = paths.scope_dir(project_scope_name(project_ulid(canonical_root)))
    stale_dir = paths.scope_dir(project_scope_name(project_ulid(stale_root)))
