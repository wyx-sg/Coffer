"""Inbound media coverage and the oversize notice (spec channels/telegram
"Download every Telegram media type without leaking the token")."""
...
# -- button vocabulary ("Use the platform's button vocabulary on cards") ------
