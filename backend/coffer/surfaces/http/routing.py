...
from coffer.surfaces.http.agent_instructions_routes import agent_instructions_router
from coffer.surfaces.http.agent_instructions_routes import (
    master_router as instructions_master_router,
)
...
from coffer.surfaces.http.mcp.registry_routes import router as mcp_registry_router
...
from coffer.surfaces.http.skill_trust_routes import router as skill_trust_router
