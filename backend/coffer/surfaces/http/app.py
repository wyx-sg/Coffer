...
async def _lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    # Wire up agent + skill kinds (specs 004, 005). The helper builds both in
    # lockstep so the cross-kind on_delete hook (agent deletion cascades into
    # skill binding cleanup) can reference both services. Best-effort first-run
