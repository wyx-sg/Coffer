...
corrupts it silently when the format moves (spec agent-registry "Toggle a plugin through the
documented location only", "Uninstall a plugin by the type's own strategy"), and it
