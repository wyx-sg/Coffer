...
The failed servers are RETURNED rather than swallowed: a client that cached a
truncated list would never see those tools again this session, so the session
records them and tells the client to re-list.
"""
