...
Spec memory "Add no table of its own", ADR
...
this table, leaving that requirement with no exception.
...
renames or regroups every file underneath it (the requirement that reapplied
the decisions after every pass is retired).
