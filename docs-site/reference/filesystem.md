...
├── channel-media/                # images received over channels
...
| `channel-media/` | Images received over Telegram and SeaTalk, saved so the agent can open them. Files older than 30 days are pruned. | daemon | No | Yes. |
