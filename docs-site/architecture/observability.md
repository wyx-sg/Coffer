...
- Decision records: [Close the Eval Flywheel](https://github.com/wyx-sg/Coffer/blob/main/docs/decisions/close-the-eval-flywheel.md), [Harness in Layers](https://github.com/wyx-sg/Coffer/blob/main/docs/decisions/industrial-grade-harness-in-layers.md), [Resource Identity Is an Immutable UID](https://github.com/wyx-sg/Coffer/blob/main/docs/decisions/resource-identity-is-an-immutable-uid.md)
