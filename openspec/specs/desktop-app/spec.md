...
- **AND** outside the credential supplier and the offline banner's Restart control, no frontend module branches on whether it is running inside the shell.
