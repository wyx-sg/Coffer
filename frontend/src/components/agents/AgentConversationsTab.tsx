...
// selecting rows enables a bulk distill. Sorting + the project/time filters were
// dropped for parity with the other tables; the default order is most-recent
// activity first (the backend default).
...
export function AgentConversationsTab({ name }: Props) {
  ...
  const columns: Column<TranscriptSessionSummary>[] = [
    ...
    {
      key: "lastActivity",
      header: t("agents.conversationsTab.colLastActivity"),
      className: "whitespace-nowrap",
