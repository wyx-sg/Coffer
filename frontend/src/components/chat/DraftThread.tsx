...
// The agent + model are chosen here in the top bar; sending the first message
// is what actually creates the conversation (see ChatPage.handleDraftSend).
...
export function DraftThread({
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      {/* Top bar: agent + model selectors (the per-conversation config, chosen
          before the first message rather than in a modal). */}
