...
import { splitFrontmatter } from "@/lib/knowledge/frontmatter";
...
interface Props {
   ...
   * renders `entry.description` itself). When true the header's `description`
   * line is suppressed to avoid showing it twice.
   */
  hideDescription?: boolean;
}

export function KnowledgePreviewBody({ text, className, initialQuery, hideDescription }: Props) {
