...
export interface paths {
  ...
  "/keychain": {
    ...
    get?: never;
    put?: never;
    /** Store a secret in the OS keychain under a reference key. */
    post: operations["setKeychainSecret"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/keychain/{ref}": {
    ...
    delete: operations["deleteKeychainSecret"];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
...
export interface components {
  schemas: {
    ...
    RetentionPolicyUpdate: {
      /** @description Set to null to keep forever; positive integer for a day count. */
      retention_days?: number | null;
    };
    PruneResultOut: {
      /**
...
export interface operations {
  ...
  setKeychainSecret: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["KeychainSetIn"];
      };
    };
    responses: {
