...
export interface components {
    schemas: {
        ...
        DaemonStatusOut: {
            ...
            version: string;
            /** @description The daemon process's executable (the frozen binary, or the interpreter of a run-from-source daemon). A CLI or shim whose version differs from `version` names it in its skew warning. */
            executable: string;
            /** Format: date-time */
            started_at: string;
            port: number;
