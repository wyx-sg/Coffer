...
// daemon (spec daemon "Open and reveal existing absolute paths", ADR
// daemon-proxies-os-file-actions). Coffer's viewers are read-only — editing happens in the user's
// own editor, not in-app.
