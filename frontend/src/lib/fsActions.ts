...
// loopback daemon (spec daemon "Open and reveal existing absolute paths", ADR
// daemon-proxies-os-file-actions), which is always on the user's own machine. There is no copy-path
// fallback.
