...
//
// Settings → Sync → Export / Import (spec vault-export-import). Two buttons, each opening the
// daemon-hosted native directory picker (spec agent-registry FR-042) to name a
