...
- **Then** the task's conversation opens on that agent and that model, the choice is recorded against that attempt, and a retry may be given a different one without rewriting what the first attempt ran on (FR-071, FR-022)
