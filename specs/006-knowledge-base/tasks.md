...
- [x] T-0023 `application/observability/tracer.py` — `Tracer` port (start_span / record_attrs / end_span); extracted as cross-cutting in this PR
...
- [x] T-0035 `infrastructure/observability/__init__.py` and `langfuse_tracer.py` (lazy import; default noop)
