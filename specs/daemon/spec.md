...
- **Given** a `daemon.log` holding Coffer's own structured JSON, a stdlib-formatted migration line, a uvicorn line, a colour-escaped line from an upstream, and a multi-line traceback,
