...
| `hermes` | `~/.hermes/` | ACP / OpenAI-compatible HTTP | ✓ `mcp_servers` YAML | ✓ `on_session_start`/`on_session_end` (config.yaml) | ✓ `model.base_url` | ✓ `memory_enabled:false` | slice 2 |
