# Research — Vault Export and Import
...
> approach has since been withdrawn: spec vault-export-import now ships a one-shot vault
> **export/import** to a directory, with no remote, no workspace, and no
> background worker ([Vault Export and Import](../../docs/decisions/vault-export-import.md),
...
[Vault Export and Import](../../docs/decisions/vault-export-import.md) and the
