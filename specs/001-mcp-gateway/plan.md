...
Phases are **delivery boundaries**.
...
`pip install -e ./backend`. This is the deliberate MVP cut.
...
### Phase 5 — User Story 4 (P3): Auditing & activity logs (audit + invocations + retention CLIs)

The audit log, invocation log, and retention framework all land in Phase 2 as
kind-agnostic plumbing; Phase 5 finishes their CLI surface (`coffer audit …`,
