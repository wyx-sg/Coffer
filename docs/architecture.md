...
knowledge root and the fieldless `builtin` source (spec knowledge FR-047, spec
skill-manager FR-028). It still differs between machines, because it lists the
