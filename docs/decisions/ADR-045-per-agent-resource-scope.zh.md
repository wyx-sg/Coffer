# ADR-045 — 按 agent 的资源 scope

> English: [ADR-045-per-agent-resource-scope.md](./ADR-045-per-agent-resource-scope.md)

- **状态：** 已采纳
- **Spec：** [010-sync](../../specs/010-sync/spec.md)（同时修订
  [001-mcp-gateway](../../specs/001-mcp-gateway/spec.md) 与
  [005-skill-manager](../../specs/005-skill-manager/spec.md)）
- **修订：** [ADR-007](./ADR-007-everything-is-a-resource-kind.zh.md)（资源现在
  携带 scope）与 [ADR-018](./ADR-018-tool-retrieval-for-overload.zh.md) /
  [ADR-024](./ADR-024-builtin-agent-is-internal-capability.zh.md)
...
（[ADR-016](./ADR-016-vault-export-import.zh.md)），赋予机器身份意义的机器注册表
