# Skill 内容信任层（启发式扫描，警告而非拦截）

> English: [skill-content-trust-layer.md](./skill-content-trust-layer.md)

- **状态：** Reverted（2026-06-20）—— 见下方撤销说明
- **日期：** 2026-06-19
- **决策者：** Yuxing Wu
- **Spec：** [skill-manager](../../specs/skill-manager/spec.zh.md)（FR-028、FR-029 —— 均已移除）
