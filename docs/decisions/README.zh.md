...
| [022](ADR-022-cross-agent-transcript-history.md)         | 跨 Agent Transcript 历史：用于搜索与浏览的本地派生索引                    | 已废弃（2026-06-14）                                                                                      |
...
| [026](ADR-026-per-agent-mcp-scoping.md)                  | 网关侧的每 agent MCP 服务器 scope                                         | Accepted                                                                                                  |
...
| [029](ADR-029-consume-official-mcp-registry.md)          | 消费官方 MCP Registry 做服务器发现                                        | Accepted                                                                                                  |
