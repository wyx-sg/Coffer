# ADR-045 — Per-Agent Resource Scope

> 中文版: [ADR-045-per-agent-resource-scope.zh.md](./ADR-045-per-agent-resource-scope.zh.md)

- **Status:** Accepted
- **Spec:** [010-sync](../../specs/010-sync/spec.md) (also amends
  [001-mcp-gateway](../../specs/001-mcp-gateway/spec.md) and
  [005-skill-manager](../../specs/005-skill-manager/spec.md))
- **Amends:** [ADR-007](./ADR-007-everything-is-a-resource-kind.md) (resources
  now carry a scope) and [ADR-018](./ADR-018-tool-retrieval-for-overload.md) /
  [ADR-024](./ADR-024-builtin-agent-is-internal-capability.md)
...
multi-machine sync. That sync is withdrawn ([ADR-016](./ADR-016-vault-export-import.md)),
