...
| [035](ADR-035-adopt-native-memory.md)                    | Adopt native memory: read the agent's own per-project store, import into Coffer             | Accepted                                                                                                      |
| [037](ADR-037-rules-runtime-injection.md)                | Rules via runtime SessionStart injection; handoff pull-on-demand                            | Accepted                                                                                                      |
