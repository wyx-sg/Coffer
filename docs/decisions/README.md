...
| [011](ADR-011-observability-tracer-port.md)              | Observability: Tracer port at `application/observability/`               | Accepted |
| [012](ADR-012-mem0-memory-engine.md)                     | Memory engine: mem0 behind an application port                           | Accepted |
